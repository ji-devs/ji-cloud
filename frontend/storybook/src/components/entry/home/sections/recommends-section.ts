...
<div slot="icon-title-paragraph">
<icon-wparagraph path="${ PATH_HEBREWAROUNDTHEWORLD}" title="${STR_TITLE_HEBREWAROUNDTHEWORLD}" paragraph="${STR_PARAGRAPH_HEBREWAROUNDTHEWORLD}" color="${STR_DARKGRAY}" >
 </icon-wparagraph>

 </div>
<div slot="icon-title-paragraph">
<icon-wparagraph path="${ PATH_KIDSINSPACE}" title="${STR_TITLE_KIDSINSPACE}" paragraph="${STR_PARAGRAPH_KIDSINSPACE}" color="${STR_DARKGRAY}" >
 </icon-wparagraph>
 </div>
<div slot="icon-title-paragraph">
<icon-wparagraph path="${ PATH_HOP}" title="${STR_TITLE_HOP}" paragraph="${STR_PARAGRAPH_HOP}" color="${STR_DARKGRAY}" >
 </icon-wparagraph>
 </div>
</recommends-section>
    `
