...
import { LeftLabel } from "~/components/entry/imagelabel/admin/images/image-label-left";
import {LabelRight} from "~/components/entry/imagelabel/admin/images/image-label-right";
