// import "@elements/entry/home/TOSORT/icon-wtitle-wparagraph";
import "@elements/entry/home/sections/jiggling-section";
import "@elements/core/titles/variants/title-section";
import { IconWTitleWParagraph } from "~/components/entry/homepage/icon-wtitle-wparagraph";
...
export const JigglingParagraph = () => {
    ...
    <div slot="icon-title-paragraph">
        ${IconWTitleWParagraph({path:STR_PATH_PinkSmiley,title:STR_TITLE_PinkSmiley, paragraph:STR_PARAGRAPH_PinkSmiley, contents:STR_BUTTONLABEL_PinkSmiley, color:STR_PINK,colorButton:STR_BLUE,weight:STR_NORMAL,size:STR_SMALL,italic:false})}
    </div>
    <div slot="icon-title-paragraph">
    ${IconWTitleWParagraph({path:STR_PATH_BlueWheel,title:STR_TITLE_BlueWheel, paragraph:STR_PARAGRAPH_BlueWheel, contents:STR_BUTTONLABEL_BlueWheel, color:STR_DARKBLUE,colorButton:STR_BLUE,weight:STR_NORMAL,size:STR_SMALL,italic:false})}
</div>
<div slot="icon-title-paragraph">
${IconWTitleWParagraph({path:STR_PATH_GreenRectangle,title:STR_TITLE_GreenRectangle, paragraph:STR_PARAGRAPH_GreenRectangle, contents:STR_BUTTONLABEL_GreenRectangle, color:STR_GREEN,colorButton:STR_BLUE,weight:STR_NORMAL,size:STR_SMALL,italic:false})}
</div>
<div slot="icon-title-paragraph">
${IconWTitleWParagraph({path:STR_PATH_YellowSquare,title:STR_TITLE_YellowSquare, paragraph:STR_PARAGRAPH_YellowSquare, contents:STR_BUTTONLABEL_YellowSquare, color:STR_ORANGE,colorButton:STR_BLUE,weight:STR_NORMAL,size:STR_SMALL,italic:false})}
</div>
<div slot="icon-title-paragraph">
${IconWTitleWParagraph({path:STR_PATH_BlueTriangle,title:STR_TITLE_BlueTriangle, paragraph:STR_PARAGRAPH_BlueTriangle, contents:STR_BUTTONLABEL_BlueTriangle, color: STR_LIGHTBLUE,colorButton:STR_BLUE,weight:STR_NORMAL,size:STR_SMALL,italic:false})}
</div>
</jiggling-section>
    `
}