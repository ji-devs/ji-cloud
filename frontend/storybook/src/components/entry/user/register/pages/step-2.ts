...
const STR_MARKETING_LABEL =
    "I would like to receive educational resources (GDPR legal text….)";

const STR_PROTECTING_PRIVACY =
    "Jewish Interactive (Ji) is committed to protecting and respecting your privacy, and we’ll only use your personal information to administer your account and to provide the products and services you requested from us.";
