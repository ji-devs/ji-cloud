...
pub const MOUSE_SCROLL_THRESHOLD: f64 = 30.0; // Number of pixels before it starts scrolling
...
pub struct Scrolling {
    ...
    pub y: Mutable<f64>,
    pub height: Mutable<f64>,
    pub total_height: Mutable<f64>,
}
...
impl Scrolling {
    ...
    //
    pub fn start(&self, mouse_y: i32) {
        log::info!("starting scroll at {}", mouse_y);

        // TODO is there a better way of calculating this ?
        let top = self.total_height.get();
