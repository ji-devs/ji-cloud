use components::{
    module::_groups::cards::edit::{config, debug::DebugSettings as BaseDebugSettings},
    tabs::MenuTabKind,
};
...
use shared::domain::jig::{
    module::{
        body::{
            ...
            _groups::cards::{BaseContent, Card as RawCard, CardContent as RawCardContent, CardPair as RawCardPair, Mode, Step},
