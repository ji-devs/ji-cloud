...
pub mod input_list {
    pub const STR_0:&'static str = "שמש";
    pub const STR_1:&'static str = "ירח";
    pub const STR_2:&'static str = "כוכב";
    pub const STR_3:&'static str = "Sun";
    pub const STR_4:&'static str = "Moon";
    pub const STR_5:&'static str = "Star";
}
