                        ...
                        vec![
                            Some(
                                SettingsButtonBuilder::new(
                                    ...
                                    clone!(state => move || state.base.play_settings.next.signal_cloned().map(|next| next == Next::ClickNext)),
                                )
                            ...
                            Some(
                                SettingsButtonBuilder::new(
                                    ...
                                    clone!(state => move || state.base.play_settings.next.signal_cloned().map(|next| next == Next::AfterAudio)),
                                )
