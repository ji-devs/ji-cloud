...
use utils::components::image_search::*;
        ...
        elem!(templates::sidebar_images(), {
            .with_data_id!("search-widget", {
                .child(ImageSearchWidget::render(
                    match crate::debug::settings().image_search {
                        None => ImageSearchWidget::new(),
                        Some(debug) => ImageSearchWidget::new_debug(debug.results, debug.is_published),
                    }
                ))
            })
            /*
