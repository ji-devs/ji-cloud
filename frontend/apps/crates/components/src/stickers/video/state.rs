...
use std::rc::Rc;
use shared::domain::jig::module::body::{Transform, _groups::design::{Video as RawVideo, VideoHost}};
...
impl Video {
    pub fn new(video:&RawVideo, on_transform_finished: Option<impl Fn(Transform) + 'static>) -> Self {
        ...
        Self {
            ...
            transform: Rc::new(TransformState::new(video.transform, Some((YOUTUBE_VIDEO_WIDTH, YOUTUBE_VIDEO_HEIGHT)), true, transform_callbacks)),
            playing_started,
            is_playing,
        }
    }
