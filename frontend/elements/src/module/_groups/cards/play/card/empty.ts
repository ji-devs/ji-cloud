...
function renderQuestionMark(theme: ThemeId) {
    const style = styleMap({ fill: `var(--theme-${theme}-cards-border-color)` });
    ...
    return svg`
		...
		<path style=${style} data-name="Path 155363" d="M124.118,19.591a19.617,19.617,0,0,0-39.234,0h11.6a8.018,8.018,0,1,1,11.962,6.962v.007a19.677,19.677,0,0,0-8.451,9.914h0a19.541,19.541,0,0,0-1.128,4.489h.011v3.468h11.854V40.964h-.022a8.051,8.051,0,0,1,3.733-4.489h-.011A19.552,19.552,0,0,0,124.118,19.591Z" />
		<circle style=${style} data-name="Ellipse 613" cx="7" cy="7" r="7" transform="translate(99 47.722)" />
		</g>
		</g>
		</svg>
	`;
