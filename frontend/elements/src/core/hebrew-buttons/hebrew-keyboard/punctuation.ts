...
export function render(punctuation: Punctuation, onClick: (char: string) => void) {
    ...
    return html`
        <button class="image-button" @click="${() => onClick(info.char)}">
            ...
            <img-ui path="module/_common/edit/widgets/hebrew-keyboard/punctuation-${punctuation}.svg"></img-ui>
        </button>
    `;
}
