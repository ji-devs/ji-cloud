    ...
    static get styles() {
        return [
            css`
                ...
                button:hover img-ui.active,
                button:active img-ui.active {
                    display: inline-block;
                }
                button:hover img-ui.inactive,
                button:active img-ui.inactive {
                    display: none;
                }
            `,
        ];
        ...
        return html`
            <button>
                <div class="label">
                    <img-ui
                        class="inactive"
                        path="entry/jig/settings/${this.kind}.svg"
                    ></img-ui>
                    <img-ui
                        class="active"
                        path="entry/jig/settings/${this.kind}-active.svg"
                    ></img-ui>
