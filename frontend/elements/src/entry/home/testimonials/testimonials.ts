    ...
    render() {
        return html`
            <div class="width-holder">
                ...
                <img-ui class="face" path="entry/home/testimonials/face.png"></img-ui>
                <div class="carousels">
                    <div class="carousel teachers">
                        <home-testimonial-carousel class="teachers-testimonials" pageCount="${this.teachersPageCount}">
                            <slot name="teachers"></slot>
                        </home-testimonial-carousel>
                    </div>
                    <div class="carousel parents">
                        <home-testimonial-carousel class="parents-testimonials" pageCount="${this.parentsPageCount}">
