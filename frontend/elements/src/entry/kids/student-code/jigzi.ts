...
export class _ extends LitElement {
        ...
        return [
            css`
                ...
                :host([mode="try-again"]) .button-wrapper {
                    clip-path: path(
                        "M297.942 165.832L72.83 138.192l-54.37 21.354 14.162-26.291-10.607-1.3a24 24 0 0 1-20.9-26.746l10.24-83.377A24 24 0 0 1 38.1.936l275.93 33.88a24 24 0 0 1 20.9 26.746l-10.237 83.374a23.979 23.979 0 0 1-26.746 20.9z"
                    );
                ...
                :host([mode="help"]) .button-wrapper {
                    clip-path: path(
                        "M348.5 192.264L97.712 161.471l-78.264 30.735 20.386-37.841L15 151.316a32 32 0 0 1-27.861-35.662l8.287-67.493A32 32 0 0 1 31.09 20.3l333.5 40.948a32 32 0 0 1 27.861 35.661L384.16 164.4a31.971 31.971 0 0 1-35.66 27.864z"
                    );
    ...
    render() {
        return html`
            ...
            <img-ui
                path="entry/home/student-code/jigzi-${this.mode}.svg"
            ></img-ui>
        `;
    }
}
