...
values ('1f241e1b-b537-493f-a230-075cb16315be', 'SGkgdGhpcyBpcyBhIHRlc3QgdG9rZW4K', 'test', 'test@test.test',
        '2020-08-08T00:11:21+00:00'::timestamptz, 'Bobby', 'Tables', 'en_US', 'en_US', true, true, 'US/Pacific-New', 'test org');

insert into "user_scope" (user_id, scope) values ('1f241e1b-b537-493f-a230-075cb16315be', 2), ('1f241e1b-b537-493f-a230-075cb16315be', 3)
